...
# pixels large.
html_favicon = '_static/hopsy.ico'
...
latex_documents = [
    (master_doc, 'hopsy.tex', u'hopsy Documentation',
     u'Richard D. Paul', 'manual'),
]
...
man_pages = [
    (master_doc, 'hopsy', u'hopsy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hopsy', u'hopsy Documentation',
     author, 'hopsy', 'One line description of project.',
     'Miscellaneous'),
]
