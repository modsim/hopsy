...
def iterative_solve(
    ...
    verbose_print(settings, "gurobi", "maximum volume ellipsoid found")
...
def check_convergence(
    ...
    verbose_print(verbose, "gurobi", "inner MVE iteration=" + str(iter))
    if (
        ...
        verbose_print(verbose, "gurobi", "stopped making progress; restarting")
        x = x + x0.squeeze()
        msg = 2
